    ...
    to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8 '>
                ...
                <p className='py-6 text-2xl'>I am available for freelance, contract and remote work.Contact with me via phone:
                    <span className='py-6 text-cyan-400'> +2349034653698</span>  or email <span className='py-6 text-cyan-400'>onwukalotachukwu210@gmail.com</span> </p>
            </div>
            <div className='flex justify-center items-center'>
                <form action='https://getform.io/f/551d8267-320b-4148-9c16-b4f583df2256' method='POST' className='flex flex-col w-full md:w-1/2'>
                    <input 
                    type='text' 
                    name='name' 
